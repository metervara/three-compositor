 ...
 * Unlit version with linear fog for depth perception.
 */

uniform float uTileScale;
uniform float uFogNear;  // Distance where fog starts (no fog)
...
void main() {
  ...
  // Unlit base color from noise
  vec3 baseColor = vec3(value);

  // Linear fog based on camera distance
